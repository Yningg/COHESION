...
import COHESION.FindBounds.findBounds_index as fb_i
...
if __name__ == '__main__':
    ...
    for dataset in dataset_list:
        ...
        index, last_mutual_t, last_t = fb_i.buildPNIndex(dataset_path, last_timestamps[dataset])
        LB_values, UB_values, time_spent = fb_i.findBoundsIndex(index, last_timestamps[dataset], decay_method, decay_rate)
        ...
        output_file = community_dir + dataset + "_communities_cohesiveness_IO_COHESION_w.txt"
